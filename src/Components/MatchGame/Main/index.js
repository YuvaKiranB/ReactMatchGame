...
import GetTab from '../TabsList'

import GetImage from '../ImagesList'

import GetGameOverCard from '../GameOverCard'
...
class MatchGame extends Component {
  ...
  playAgain = () => {
    this.setState({isGameEnd: false, score: 0, time: 60})
    this.timerId = setInterval(this.tick, 1000)
  }

  render() {
    const {activeCategory, isGameEnd, displayImage, score, time} = this.state
      ...
      <div className="main">
        <div className="content">
            ...
            <li>
              <div className="scoreAndTimeContainer">
                <div className="scoreContainer">
                  <p className="p1">
                    Score:<span className="span1">{score}</span>
                  </p>
                </div>
          ...
          {isGameEnd ? (
            <GetGameOverCard
              totalScore={score}
              clickedPlayAgain={this.playAgain}
            />
          ) : (
